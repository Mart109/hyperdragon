    ...
    <div className="home-page">
      <div className="game-container">
          ...
          <div className="upgrades-grid">
            <div
              className={`upgrade-card ${
                energyRestores === 0 || energy >= maxEnergy ? 'disabled' : ''
              }`}
              onClick={handleRestoreEnergy}
            >
              <div className="upgrade-header">
                <div className="upgrade-icon energy-boost">⚡</div>
                <div className="upgrade-content">
                  <h4>Восстановить энергию</h4>
                  <p>Полностью восстановить энергию до максимума</p>
                </div>
              </div>
              <div className="upgrade-details">
                <span className="upgrade-price">Бесплатно</span>
                <span className="upgrade-uses">
                  Осталось: {energyRestores}/3 в день
                </span>
              </div>
              <button
                ...
                disabled={energyRestores === 0 || energy >= maxEnergy}
              >
                {energyRestores > 0
                  ? energy >= maxEnergy
                    ? 'Энергия полная'
        ...
        <footer className="game-footer">
          <p>✨ Hype Dragon - игра обновляется ежедневно! ✨</p>
        </footer>
      </div>
    </div>
  )
